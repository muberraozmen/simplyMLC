...
__all__ = ['TransformerEncoderLayer', 'TransformerEncoder', 'ModifiedDecoderLayer', 'TransformerDecoder']
...
class ModifiedDecoderLayer(Module):
    __constants__ = ['batch_first', 'norm_first']
    ...
    def __setstate__(self, state):
        if 'activation' not in state:
            state['activation'] = F.relu
        super(ModifiedDecoderLayer, self).__setstate__(state)
